    ...
    <div class="container px-6 md:px-12">
      <div
        ...
        <div class="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
          <div class="mx-auto mb-12 text-center lg:mb-0" data-aos="fade-up">
          ...
          <div class="mx-auto mb-6 text-center md:mb-0" data-aos="fade-up">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
              stroke="currentColor" class="mx-auto mb-6 h-8 w-8 text-primary dark:text-primary-400">
              <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="my-6">
            <div class="max-w-6xl mx-auto bg-red-100 rounded-lg">
                <div class="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]" data-aos="fade-up">
                    <div >
                        <h1 class="text-4xl font-extrabold text-gray-400" data-aos="fade-up">Get in Touch</h1>
                        <p class="text-sm text-gray-400 mt-3" data-aos="fade-up">Have some big idea or brand to develop and need help? Then reach out we'd love to hear about your project  and provide help.</p>
                        <ul class="mt-12 space-y-8">
                            <li class="flex items-center" data-aos="fade-up">
                                ...
                                <a href="javascript:void(0)" class="text-gray-400 text-sm ml-3">
                        ...
                        <ul class="flex mt-12 space-x-4"  data-aos="fade-up">
                    ...
                    <div class="bg-gray-200 p-6 rounded-lg">
                        <p class="text-sm font-semibold text-[#333]" data-aos="fade-up">I'm interested in...</p>
                        <div class="space-y-4 max-lg:mt-4" data-aos="fade-up">
                        ...
                        <form class="mt-8 space-y-4" onSubmit={sendEmail} data-aos="fade-up">
                  ...
                  required
                                class="w-full rounded-md py-3 px-4 text-sm outline-[#a91079]" />
                                 <input type='number' placeholder='Enter Your Phone Number'   name="from_phone"
                required
                                class="w-full rounded-md py-3 px-4 text-sm outline-[#a91079]" />
                            <input type='text' placeholder='Enter Your Subject'   name="from_subject"
                required
                                class="w-full rounded-md py-3 px-4 text-sm outline-[#a91079]" />
                            <textarea placeholder='Enter Your Message' rows="6"   name="from_message"
                required
