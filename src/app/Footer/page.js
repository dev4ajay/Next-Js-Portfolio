...
<footer className="bg-blue-100/80 font-sans dark:bg-gray-900 mt-5">
    <div className="container px-6 py-12 mx-auto">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            <div className="sm:col-span-2" data-aos="fade-up">
                ...
                <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row" data-aos="fade-up">
            ...
            <div data-aos="fade-up">
                ...
                <div className="flex flex-col items-start mt-5 space-y-2" data-aos="fade-up">
        ...
        <div className="sm:flex sm:items-center sm:justify-between" >
            <div className="flex flex-1 gap-4 hover:cursor-pointer" data-aos="fade-up">
                <img src="https://www.svgrepo.com/show/303139/google-play-badge-logo.svg" width="130" height="110" alt="" />
                <img src="https://www.svgrepo.com/show/303128/download-on-the-app-store-apple-logo.svg" width="130" height="110" alt="" />
            </div>
            
            <div className="flex gap-4 hover:cursor-pointer" data-aos="fade-up">
