...
<div className="dark:bg-gray-900">
            <div>
                <div className="relative">
                    ...
                    {/* For md screen size */}
                    {/* For large screens */}
                    <div className=" bg-slate-200 px-6 py-9 śśśśśśśśśśśśśśśśśśśśśśśśśśśśñññññññññññññññ" style={{boxShadow: "rgba(0, 0, 0, 0.16) 0px 10px 36px 0px, rgba(0, 0, 0, 0.06) 0px 0px 0px 1px"}}>
                        <div className="container mx-auto flex items-center justify-between">
                            <h1 className="md:w-2/12 cursor-pointer text-gray-800 dark:text-white" aria-label="Ajay Kumar">
                                <svg className="fill-stroke" width={93} height={19} viewBox="0 0 93 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path
                                        ...
                                        fill="currentColor"śśśśśśśśśśśśśśśśśśśśśśśśśśśśñññññññññññññññ
                                    />
                                </svg>
                            </h1>
                            <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8">
                                <li>
                                    <Link href="/" className="dark:text-white text-base text-gray-800    hover:underline">
                                        Home
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/about" className="dark:text-white text-base text-gray-800    hover:underline">
                                     About-Us
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/services" className="dark:text-white text-base text-gray-800    hover:underline">
                                    services
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/blog" className="dark:text-white text-base text-gray-800    hover:underline">
                                  Blog
                                    </Link>
                                </li>
                                <li>
                                    <Link href="contact" className="dark:text-white text-base text-gray-800    hover:underline">
                                        Contact
                                    </Link>
                                </li>
                            </ul>
                    ...
                    <div id="mobile-menu" className={`${showMenu ? "flex" : "hidden"} absolute dark:bg-gray-900 z-10 inset-0 md:hidden bg-white flex-col h-screen w-full`}>
                        ...
                        <div className="mt-6 p-4">
                            <ul className="flex flex-col space-y-6">
                                <li>
                                    <Link href="/" className="dark:text-white flex items-center justify-between hover:underline text-base text-gray-800">
                                        Home
                                        <div>
                                ...
                                <li>
                                    <Link href="/about" className="dark:text-white flex items-center justify-between hover:underline text-base text-gray-800">
                                        About Us
                                        <div>
                                            <svg className="fill-stroke text-black dark:text-white" width={12} height={12} viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M4.5 3L7.5 6L4.5 9" stroke="currentColor" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                ...
                                <li>
                                    <Link href="/services" className="dark:text-white flex items-center justify-between hover:underline text-base text-gray-800">
                                    Services
                                        <div>
                                            <svg className="fill-stroke text-black dark:text-white" width={12} height={12} viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M4.5 3L7.5 6L4.5 9" stroke="currentColor" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                ...
                                <li>
                                    <Link href="/blog" className="dark:text-white flex items-center justify-between hover:underline text-base text-gray-800">
                                   Blog
                                        <div>
                                            <svg className="fill-stroke text-black dark:text-white" width={12} height={12} viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M4.5 3L7.5 6L4.5 9" stroke="currentColor" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
                                ...
                                <li>
                                    <Link href="/contact" className="dark:text-white flex items-center justify-between hover:underline text-base text-gray-800">
                                       Contact
                                        <div>
                                            <svg className="fill-stroke text-black dark:text-white" width={12} height={12} viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M4.5 3L7.5 6L4.5 9" stroke="currentColor" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
