...
<footer class="bg-blue-100/80 font-sans dark:bg-gray-900 mt-5">
    <div class="container px-6 py-12 mx-auto">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            <div class="sm:col-span-2" data-aos="fade-up">
                ...
                <div class="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row" data-aos="fade-up">
            ...
            <div data-aos="fade-up">
                ...
                <div class="flex flex-col items-start mt-5 space-y-2" data-aos="fade-up">
        ...
        <div class="sm:flex sm:items-center sm:justify-between" >
            <div class="flex flex-1 gap-4 hover:cursor-pointer" data-aos="fade-up">
                <img src="https://www.svgrepo.com/show/303139/google-play-badge-logo.svg" width="130" height="110" alt="" />
                <img src="https://www.svgrepo.com/show/303128/download-on-the-app-store-apple-logo.svg" width="130" height="110" alt="" />
            </div>
            
            <div class="flex gap-4 hover:cursor-pointer" data-aos="fade-up">
